  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <Image
          src="/special-olympics-v1/public/images/grey-golf.png"
        ...
        <div className="relative z-20 container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            Competitive sports breed common ground. Athletes, coaches and the
            people who support them come together for the love of a sport or the
            thrill of a game.
          </p>
        </div>
      </section>
      ...
      {/* Main Content */}
      <section
        data-section="who-we-are-mission"
        className="py-20 container mx-auto px-4"
      >
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-gray-700 leading-relaxed">
              Through Special Olympics New York, though, everyone is included.
              Athletes with intellectual disabilities have the opportunity to
              challenge themselves in fair and even competition. Win or lose,
              they develop their own character, make friends and find unknown
              wells of determination within themselves.
            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
              If you're a fan of unity, acceptance, empowerment, dignity, pride
              and fun, you're a fan of Special Olympics New York.
            </p>
                ...
                <div className="flex-1 bg-primary text-white p-8 rounded-lg relative">
                  <div className="max-w-3xl">
                    ...
                    <p className="text-white text-lg leading-relaxed">
                      ...
                      competition in a variety of Olympic-style sports for
                ...
                <div className="flex-1 bg-white p-8 rounded-lg relative">
                  ...
                  <div className="relative z-10 max-w-4xl">
                    ...
                    <p className="text-gray-800 text-lg leading-relaxed">
                      Eunice Kennedy Shriver founded Special Olympics in 1968.
                      Just one year later, Dorothy Buehring Phillips inaugurated
                      the program in New York—and the state sent its first
                      delegation of athletes and coaches to the Northeast
                      Regional Special Olympics competition in Boston, Mass.
                      Special Olympics New York was incorporated in 1970 with
                      Phillips as its first State Director. In June 1970,
                      Rochester hosted the first State Summer Games. Today,
                      Special Olympics New York is the largest program in the
